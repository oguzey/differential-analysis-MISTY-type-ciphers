...
systems[8] = System(
    ...
    transitions=[
        ...
        Transition(Side(a4), Side(b2, cp_with_lo(b1, lmbda)), G),
        Transition(Side(a3), Side(b3, cp_with_lo(b2, mu)), F),
        Transition(Side(a2), Side(b4, cp_with_lo(b3, lmbda)), G),
        Transition(Side(b1), Side(c1, cp_with_lo(b4, mu)), F),
        Transition(Side(b2), Side(c4, cp_with_lo(c1, lmbda)), G),
        Transition(Side(b3), Side(c3, cp_with_lo(c4, mu)), F),
...
systems[9] = System(
    ...
    transitions=[
        ...
        Transition(Side(a3), Side(b3, cp_with_lo(b2, mu)), F),
        Transition(Side(a2), Side(b4, cp_with_lo(b3, lmbda)), G),
        Transition(Side(b1), Side(b5, cp_with_lo(b4, mu)), F),
        Transition(Side(b2), Side(c1, cp_with_lo(b5, lmbda)), G),
        Transition(Side(b3), Side(c4, cp_with_lo(c1, mu)), F),
        Transition(Side(b4), Side(c3, cp_with_lo(c4, lmbda)), G),
        Transition(Side(b5), Side(c2, cp_with_lo(c3, mu)), F)
    ]
)
...
systems[10] = System(
    ...
    transitions=[
        ...
        Transition(Side(a2), Side(b4, cp_with_lo(b3, lmbda)), G),
        Transition(Side(b1), Side(b5, cp_with_lo(b4, mu)), F),
        Transition(Side(b2), Side(b6, cp_with_lo(b5, lmbda)), G),
        Transition(Side(b3), Side(c1, cp_with_lo(b6, mu)), F),
        Transition(Side(b4), Side(c4, cp_with_lo(c1, lmbda)), G),
        Transition(Side(b5), Side(c3, cp_with_lo(c4, mu)), F),
...
systems[11] = System(
    ...
    transitions=[
        ...
        Transition(Side(b1), Side(b5, cp_with_lo(b4, mu)), F),
        Transition(Side(b2), Side(b6, cp_with_lo(b5, lmbda)), G),
        Transition(Side(b3), Side(b7, cp_with_lo(b6, mu)), F),
        Transition(Side(b4), Side(c1, cp_with_lo(b7, lmbda)), G),
        Transition(Side(b5), Side(c4, cp_with_lo(c1, mu)), F),
        Transition(Side(b6), Side(c3, cp_with_lo(c4, lmbda)), G),
        Transition(Side(b7), Side(c2, cp_with_lo(c3, mu)), F)
    ]
)
...
systems[12] = System(
    ...
    transitions=[
        ...
        Transition(Side(b2), Side(b6, cp_with_lo(b5, lmbda)), G),
        Transition(Side(b3), Side(b7, cp_with_lo(b6, mu)), F),
        Transition(Side(b4), Side(b8, cp_with_lo(b7, lmbda)), G),
        Transition(Side(b5), Side(c1, cp_with_lo(b8, mu)), F),
        Transition(Side(b6), Side(c4, cp_with_lo(c1, lmbda)), G),
        Transition(Side(b7), Side(c3, cp_with_lo(c4, mu)), F),
...
systems[13] = System(
    ...
    transitions=[
        ...
        Transition(Side(b3), Side(b7, cp_with_lo(b6, mu)), F),
        Transition(Side(b4), Side(b8, cp_with_lo(b7, lmbda)), G),
        Transition(Side(b5), Side(b9, cp_with_lo(b8, mu)), F),
        Transition(Side(b6), Side(c1, cp_with_lo(b9, lmbda)), G),
        Transition(Side(b7), Side(c4, cp_with_lo(c1, mu)), F),
        Transition(Side(b8), Side(c3, cp_with_lo(c4, lmbda)), G),
        Transition(Side(b9), Side(c2, cp_with_lo(c3, mu)), F)
    ]
)
...
systems[14] = System(
    ...
    transitions=[
        ...
        Transition(Side(b4), Side(b8, cp_with_lo(b7, lmbda)), G),
        Transition(Side(b5), Side(b9, cp_with_lo(b8, mu)), F),
        Transition(Side(b6), Side(b10, cp_with_lo(b9, lmbda)), G),
        Transition(Side(b7), Side(c1, cp_with_lo(b10, mu)), F),
        Transition(Side(b8), Side(c4, cp_with_lo(c1, lmbda)), G),
        Transition(Side(b9), Side(c3, cp_with_lo(c4, mu)), F),
