...
systems[4] = System(
    ...
    outputs=[c2, c3, c4],
    transitions=[
        Transition(Side(a1), Side(c1, cp_with_lo(c4, mu)), F),                                                       #  Transition(Side(a1), Side(b1), F),
        Transition(Side(a2, cp_with_lo(c1, lmbda), cp_with_lo(c4, mu, lmbda)), Side(c2), G),                      #  Transition(Side(a2, cp_with_lo(b1, lmbda)), Side(c2), G),
